export default function cursor(canvas) {
  try {
    ("use strict");
...
`
    ...
    void main () {
        ...
        gl_FragColor = vec4(vel + force * dt, 0.0, 0.0);
    }
`
    );
...
`
    ...
    window.addEventListener("mousemove", () => {
      ...
      pointers[0].color = [0.808, 0.125, 0.153];
    });
    ...
    console.error("Fluid init failed:", error);
  }
}
